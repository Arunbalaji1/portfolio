       ...
       <div className="flex md:hidden flex-row mb-3 justify-between items-center  bg-[#eb5e28]/20 rounded-md backdrop-blur-xs overflow-hidden">
                 <div className=" h-[10vw] w-[10vw]   mx-2 my-2 ">
                     <Tooltip title="arunbalajimanickam@gmail.com">
                        <a target="_blank" href="mailto:arunbalajimanickam@gmail.com"><img src={mail_img} alt="mail_img" className="animate-floatmild" /></a>
                     </Tooltip>
                 </div>
                 <div className=" h-[10vw] w-[10vw]   mx-2 my-2 ">
                    <Tooltip title="+91 8838477434">
                       <a target="_blank" href="tel:+91 8838477434"><img src={phone_img} alt="phone_img" className="animate-floatmild" /></a>
                    </Tooltip>
                 </div>
                 <div className=" h-[10vw] w-[10vw]   mx-2 my-2 ">
                     <Tooltip title="linkedin/arunbalaji2003">
                       <a target="_blank" href="https://www.linkedin.com/in/arunbalaji2003/"><img src={linkedin_img} alt="linkedin_img" className="animate-floatmild" /></a>
                     </Tooltip>
                 </div>
                 <div className=" h-[10vw] w-[10vw]   mx-2 my-2 ">
                     <Tooltip title="github/Arunbalaji1">
                       <a target="_blank" href="https://github.com/Arunbalaji1" ><img src={github_img} alt="github_img" className="animate-floatmild" /></a>
                     </Tooltip>
                 </div>
               </div>
  ...
  return(
       <div>
        ...
        <div className="grid grid-cols-4 h-[75vh] md:pl-5 p-5  rounded-2xl mt-3 md:mt-10 md:mx-[5vw] lg:mx-[10vw] xl:mx-[15vw] md:bg-amber-50 dark:md:bg-[#203c56] md:shadow-2xl   dark:md:border-1  dark:md:border-[#6b2d14b1]">
          ...
          <div className="hidden md:col-span-2 animate-fade-in bg-cover bg-center md:flex flex-col justify-end items-center " style={{ backgroundImage: `url(${contact_img})` }}>
