        ...
        <div className="w-full md:w-fit  h-fit mt-10 md:mt-23   ring-2 ring-[#eb5e28]   rounded-2xl flex flex-col  md:flex-row bg-white/20 backdrop-blur-xs justify-around items-center">
          ...
          <div className="">
            <img
              ...
              alt="Arun Profile"
              className="shadow-[#eb5e28] m-4  md:ml-10 rounded-full shadow-lg border-1 border-[#eb5e28]/50 md:rounded-full w-[40vw] h-[40vw]   md:w-[40vh] md:h-[40vh] object-cover "
            />
          </div>
          {/* Right content box */}
          <div className=" indent-18 text-justify text-[3.8vw] sm:text-[1.9vw] md:text-[1.8vw] lg:text-[1.5vw]  xl:text-[1.3vw]  md:m-3   px-4 pb-4 md:p-4 rounded-md w-full md:w-[50vw] h-fit font-semibold    italic  text-black dark:text-white/80">
              <p>
