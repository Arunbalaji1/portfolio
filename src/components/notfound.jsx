...
const Notfound = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen relative text-center px-4">
      <img src={notfound} alt="" className='mx-auto h-[80%] absolute -top-20' />
      ...
      <Link
        to="/"
        className="bg-[#eb5e28] text-white px-6 py-2 rounded hover:bg-[#ef4e0e] transition"
      >
        Go Home
      </Link>
    </div>
