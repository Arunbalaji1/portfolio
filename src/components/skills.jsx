...
import figmaLogo from '../assets/skills_icons/Figma.png';
import gitLogo from '../assets/skills_icons/Git.png';
import githubLogo from '../assets/skills_icons/GitHub.png';
import mysqlLogo from '../assets/skills_icons/Mysql.png';
import numpyLogo from '../assets/skills_icons/NumPy.png';
...
import javaLogo from '../assets/skills_icons/Java.png';
...
export default function Skill(){
  return<>
   ...
   <section className="   col-span-12 skills flex flex-col pt-5  pb-8 h-fit  items-center gap-4 mt-2">
    ...
    <div className="grid  grid-cols-7 bg-gradient-to-b sm:bg-gradient-to-l from-[rgb(235,94,40)] via-[rgb(241,131,91)] to-[rgb(239,198,183)]  dark:via-[rgba(128,63,42,0.19)] dark:to-[#14202b]   rounded-md p-1 sm:p-5   m-2 sm:m-0 h-fit sm:h-[25vh] w-[80vw] sm:w-[90vw]  ">
